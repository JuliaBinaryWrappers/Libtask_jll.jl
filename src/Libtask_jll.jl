...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Libtask_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3ae2931a-708c-5973-9c38-ccf7496fb450"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Libtask", artifacts_toml) for e in artifacts["Libtask"]]
...
if best_platform === nothing
    @debug("Unable to load Libtask; unsupported platform $(triplet(platform_key_abi()))")
else
