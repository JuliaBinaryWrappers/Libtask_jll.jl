# Autogenerated wrapper script for Libtask_jll for x86_64-apple-darwin14
export libtask_v1_1, libtask_v1_2, libtask_v1_0, libtask_v1_3
...
const libtask_v1_1_splitpath = ["lib", "libtask_v1_1.dylib"]
...
const libtask_v1_1 = "@rpath/libtask_v1_1.dylib"


# Relative path to `libtask_v1_2`
const libtask_v1_2_splitpath = ["lib", "libtask_v1_2.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libtask_v1_2 = "@rpath/libtask_v1_2.dylib"


# Relative path to `libtask_v1_0`
const libtask_v1_0_splitpath = ["lib", "libtask_v1_0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libtask_v1_0 = "@rpath/libtask_v1_0.dylib"


# Relative path to `libtask_v1_3`
const libtask_v1_3_splitpath = ["lib", "libtask_v1_3.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libtask_v1_3 = "@rpath/libtask_v1_3.dylib"
